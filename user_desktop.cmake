...
elseif(IS_MY_LINUX_SYSTEM)
    ...
    set(LEAP_LIB_DIR /home/maiermic/Downloads/LeapDeveloperKit_2.3.1+31549_linux/LeapSDK/lib/x64 CACHE PATH ${USER_CMAKE_TEXT})
else()
  #set(BOOST_ROOT /sw/boost/1.53.0  CACHE PATH ${USER_CMAKE_TEXT})
  set(OPENSG_ROOT $ENV{HOME}/opensg/latest CACHE PATH ${USER_CMAKE_TEXT})
  set(inVRs_ROOT_DIR $ENV{HOME}/inVRs/latest CACHE PATH ${USER_CMAKE_TEXT})
  set(CAVESceneManager_DIR $ENV{HOME}/inVRs/latest/lib/cmake/CAVESceneManager CACHE PATH ${USER_CMAKE_TEXT})
  set(VRPN_ROOT_DIR $ENV{HOME}/vrpn/latest CACHE PATH ${USER_CMAKE_TEXT})
endif()


MESSAGE("CAVECSM: ${CAVESceneManager_DIR}")
