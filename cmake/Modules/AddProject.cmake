...
function(_add_project_setup ADD_PROJECT_NAME)
	...
	set(_oneValueArgs "")
	set(_multiValueArgs MAIN_FILE SOURCE_DIR HEADER_DIR CONFIGS MODELS IMAGES DOCS OPENSG_MODULES INVRS_MODULES BOOST_MODULES)
	...
	if("${ADD_PROJECT_MAIN_FILE}" STREQUAL "")
		MESSAGE("No main file given")
	else()
		SET(SRCS ${SRCS} ${ADD_PROJECT_MAIN_FILE})
	endif()
	...
	MESSAGE("libs: ${${ADD_PROJECT_NAME}_LIBRARIES}")
