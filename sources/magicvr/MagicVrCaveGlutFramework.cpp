...
namespace magicvr {
    ...
    void
    MagicVrCaveGlutFramework::keyboardDown(unsigned char key, int x, int y) {
        ...
        switch (key) {
            ...
            case 'h':
                ...
                std::cout << "following head: " << std::boolalpha
                          << cfg.getFollowHead() << '\n';
                break;
            case 'i':
    ...
    MagicVrCaveGlutFramework::MagicVrCaveGlutFramework(
    ...
    void MagicVrCaveGlutFramework::idle() {
        ...
        mgr.setTranslation(
                mgr.getTranslation() + speed * remoteManager.analog_values);
